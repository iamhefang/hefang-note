...
export default function View() {
  ...
  const {
    token: { colorBgContainer, colorBgBase, Layout: layoutColors, colorTextBase },
  } = antdTheme.useToken()
  ...
  useEffect(() => {
    localStorage.setItem("bgColor", colorBgContainer)
    window.shell?.api.setThemeColor({ bgColor: colorBgContainer, fgColor: layoutColors?.headerColor ?? colorTextBase })
  }, [colorBgContainer, colorTextBase, layoutColors?.headerColor])
