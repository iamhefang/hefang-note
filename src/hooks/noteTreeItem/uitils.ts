import { ContentIODirection, ContentIOEvent, ContentIOType, NoteItem, PluginHookOccasion } from "hefang-note-types"
  ...
  return new Promise((resolve, reject) => {
    contentStore
      ...
      .then((content) => {
        ...
        saveFile(finalContent, { mimeType, fileName: `${title}.${fileExt}` })
          .then((res) => {
            callPluginsHook(
              "onContentExport",
              new ContentIOEvent({
